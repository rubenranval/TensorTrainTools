<|"IndexedPaths" -> None, "Driver" -> "Lucene", 
 "CreationDate" -> DateObject[{2026, 7, 20, 11, 23, 
    29.1632821`9.2174113089156}, "Instant", "Gregorian", 2.], "Version" -> 5, 
 ...
 "ContentFieldOptions" -> <|"Title" -> <|"Stored" -> True, "Weight" -> 2|>, 
  ...
  <|"NotebookType" -> {"Symbol" -> 1., "Guide" -> 1., "Root Guide" -> 1., 
     ...
     "Overview" -> 0.8333333333333334, "Connection" -> 0.8333333333333334, 
     "Database Connection" -> 0.8333333333333334, "Device Connection" -> 
      0.8333333333333334, "Service Connection" -> 0.8333333333333334, 
     "Text Content" -> 0.8333333333333334, "Incremental Object" -> 
